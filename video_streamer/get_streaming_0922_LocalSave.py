...
# 영상 저장위한 설정들(web)
file_path_0 = 'record_0.mp4'
file_path_1 = 'record_1.mp4'
                    ...
                    if check_0==1 or check_1==1:
                        ...
                        if time_list1:
                            ...
                            try:
                                ...
                                if position == 0:
                                    os.rename(f'record_0.mp4', f'C0' + '_' + f'{time_check1}_{time_check2}.mp4')
                                elif position == 1:
                                    os.rename(f'record_1.mp4', f'C1' + '_' + f'{time_check1}_{time_check2}.mp4')
        ...
        if ret:
            ...
            if request_check0 == 0 and request_check1 == 0:
                if len(time_list2) >= 2:
                    ...
                    data = {f"suspicionVideoPath01": 'C0' + '_' + f"{time_check1}_{time_check2}.mp4",
                            f"suspicionVideoPath02": 'C1' + '_' + f"{time_check1}_{time_check2}.mp4",
